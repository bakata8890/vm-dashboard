...
git clone https://github.com/bakata8890/vm-dashboard.git
cd vm-dashboard
...
La arquitectura está diseñada para desplegarse en GCP (Cloud Run + BFF + IAM service-to-service), documentada en `files/SDD-VM-Dashboard.md` §8, pero la entrega funcional es 100% local vía docker-compose por restricción de tiempo.
